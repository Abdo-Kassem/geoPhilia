                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> اضافة كلمة مؤسس المبادرة</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('dashboard.founder_speech.store') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i>اضافة صورة
                                                </h4>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="image" class="card-title ml-1">اضف صوره
                                                        </label>
