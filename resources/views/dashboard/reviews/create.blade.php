                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> اضافة مقال
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> اضافة مقال </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('dashboard.reviews.store') }}"
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> مقالات
                                                </h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group  mt-1">
                                                            ...
                                                            <input type="text" value="" id="review"
                                                                class="form-control" placeholder="اضف عنوان المقال " required
                                                                name="review">
                                                            @error('review')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        ...
                                                        <select name="cat_id" class="form-control" required>
                                                            ...
                                                            @foreach ($maincategories as $maincategory)
                                                                <option value="{{ $maincategory->id }}"
                                                                    {{ request()->cat_id == $maincategory->id ? 'selected' : '' }}>
