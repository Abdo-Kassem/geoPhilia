                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            action="{{ route('dashboard.manageFront.storeService') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات خدمة
                                                </h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group  mt-1">
                                                            ...
                                                            <input type="text" value="" id="service" class="form-control"
                                                                placeholder="ادخل    اسم الخدمة   " name="service">
                                                            @error('service')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group  mt-1">
                                                            ...
                                                            <input type="text" value="" id="url" class="form-control"
                                                                placeholder="ادخل    لينك الخدمة   " name="url">
                                                            @error('url')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
